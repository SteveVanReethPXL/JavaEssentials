...
import be.pxl.h2.oef1.Persoon;
import org.junit.Before;
import org.junit.Test;

import static org.junit.Assert.assertEquals;

public class PersoonOef2Test1 {
	...
	public void testToString() {
		...
		StringBuilder tekst = new StringBuilder(
				"Deze persoon is " + persoon.getVoornaam().toUpperCase() + " " + persoon.getNaam().toUpperCase() + "\n");
	...
	public void testBerekenBmi() {
		...
		persoon.setGewicht(50);
		assertEquals(Math.round(50 / (1.5 * 1.5) * 10) / 10.0, persoon.berekenBmi(), 0);
	}
	...
	public void testGetLeeftijd() {
		...
		assertEquals(18, persoon.getLeeftijd());
	}
